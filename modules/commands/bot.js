    ...
    switch (handleReply.type) {
      ...
      var time = process.uptime(),
          ...
          ${Date.now() - ping}ms.\n\n`}`
            ...
            ❯ Zalo: 0??????????
            ❯ Cân nặng: ?0kg
            ❯ Facebook: fb.me/100038740121428
            ❯ Cảm ơn đã sử dụng bot của Quốc Duy <3\n\n----Quoc Duy----`,
              attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
              fs.unlinkSync(__dirname + "/cache/1.png"));  
                return request(
                  encodeURI(`https://graph.facebook.com/${100038740121428}/picture?height=720&width=720&access_token=100092388170006|aa417da57f9e260d1ac1ec4530b417de`)).pipe(
              ...
              if (timeByMS - totalChat[event.threadID].time > _24hours) {
                if (timeByMS - totalChat[event.threadID].time > (_24hours * 2)) {
                  ...
                  return api.sendMessage("𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐫𝐞𝐥𝐨𝐚𝐝𝐞𝐝 𝐜𝐨𝐧𝐟𝐢𝐠.𝐣𝐬𝐨𝐧", event.threadID, event.messageID);    
                            ...
                            /// admin only ///
                          case "5": {
                            if (event.senderID != 100038740121428) return api.sendMessage(`» 𝐌𝐚̀𝐲 𝐓𝐮𝐨̂̉𝐢 𝐂𝐚̣̆𝐜 𝐆𝐢̀ 𝐌𝐚̀ 𝐗𝐚̀𝐢 😏`, event.threadID, event.messageID)
