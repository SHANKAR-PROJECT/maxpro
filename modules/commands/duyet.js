...
module.exports.run = async  ({ event, api, args, Threads, Users, handleReply  }) => {
  ...
  const fs = require("fs");
axios.get('https://apitoansex.dz1toan.repl.co/slap').then(res => {
...
→ 𝗠𝗼̣𝗶 𝘁𝗵𝗮̆́𝗰 𝗺𝗮̆́𝗰 𝗰𝘂̛́ 𝗹𝗶𝗲̂𝗻 𝗵𝗲̣̂ 𝗮𝗱𝗺𝗶𝗻 𝗯𝗼𝘁: https://fb.me/1053703548
━━━━━━━━━━━━━━━━━━
→ 𝗧𝗵𝗶𝘀 𝗯𝗼𝘁 𝗺𝗮𝗱𝗲 𝗯𝘆:𝐁𝐨𝐭 - 𝐊𝐚𝐲 𝐒𝐩𝐞𝐞𝐝 𝐕𝐍 
→ 𝗧𝗵𝗮𝗻𝗸 𝘆𝗼𝘂 𝗳𝗼𝗿 𝘂𝘀𝗶𝗻𝗴
→ 𝗔𝗱𝗺𝗶𝗻 𝗕𝗼𝘁: Cái Hoàng Luân   ღ﹏✍`,
