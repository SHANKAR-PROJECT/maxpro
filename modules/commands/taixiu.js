...
module.exports.run = async function ({ api, event, args, Currencies, Users}) {
  ...
  if (ketqua == 'thua') {
    ...
    return api.sendMessage({ body: `🌸𝐗𝐢́ 𝐧𝐠𝐚̂̀𝐮 𝐫𝐚: ${xnmot}, ${xnhai} và ${xnba}\nTổng là ${tong} nút\n💵 𝗕𝗮̣𝗻 𝘁𝗵𝗮̆́𝗻𝗴 𝗰𝘂̛𝗼̛̣𝗰! +${tiencuoc}$\n𝐋𝐨̛̀𝐢 𝐤𝐡𝐮𝐲𝐞̂𝐧 :𝐂𝐨̛̀ 𝐛𝐚̣𝐜 𝐜𝐨́ 𝐭𝐡𝐚̆́𝐧𝐠 𝐜𝐨́ 𝐭𝐡𝐮𝐚, 𝐭𝐡𝐚̆́𝐧𝐠 𝐭𝐡𝐢̀ 𝐢́𝐭 𝐦𝐚̀ 𝐭𝐡𝐮𝐚 𝐭𝐡𝐢̀ 𝐧𝐡𝐢𝐞̂̀𝐮`, attachment: fs.createReadStream(pathImg) },
      threadID,
      () => fs.unlinkSync(pathImg),
      messageID);
  }
    ...
    Currencies.decreaseMoney(senderID, tiencuoc);
    return api.sendMessage({ body: `𝐗𝐢́ 𝐧𝐠𝐚̂̀𝐮 𝐫𝐚: ${xnmot}, ${xnhai} và ${xnba}\nTổng là ${tong} nút\n💵 𝐁𝐚̣𝐧 𝐭𝐡𝐮𝐚 𝐬𝐦 -${tiencuoc}$\n𝐋𝐨̛̀𝐢 𝐤𝐡𝐮𝐲𝐞̂𝐧 :"𝐂𝐨̛̀ 𝐛𝐚̣𝐜, 𝐤𝐡𝐢𝐞̂́𝐧 𝐜𝐡𝐮́𝐧𝐠 𝐭𝐚 𝐦𝐚̂́𝐭 𝐡𝐚𝐢 𝐭𝐡𝐮̛́ 𝐪𝐮𝐲́ 𝐠𝐢𝐚́ 𝐧𝐡𝐚̂́𝐭 𝐜𝐮̉𝐚 𝐝𝐨̛̀𝐢 𝐧𝐠𝐮̛𝐨̛̀𝐢. 𝐃𝐨́ 𝐥𝐚̀ 𝐭𝐡𝐨̛̀𝐢 𝐠𝐢𝐚𝐧 𝐯𝐚̀ 𝐭𝐢𝐞̂̀𝐧 𝐛𝐚̣𝐜`, attachment: fs.createReadStream(pathImg) },
      threadID,
      () => fs.unlinkSync(pathImg),
      messageID);
  };
