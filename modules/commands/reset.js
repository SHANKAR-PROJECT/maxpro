...
//if (permssion != 3) return api.sendMessage(`[DONATE]→ Momo/Mbbank: 0866001952. Xin cám ơn ạ!! ❤️`, threadID, messageID);
if(args.length == 0) api.sendMessage(`Dạ thưa ADMIN ${name}\n🔰ADMIN vui lòng chờ em trong giây lát, BOT sẽ quay trở lại sau 10s ạ`,event.threadID, () =>process.exit(1))
else{    
let time = args.join(" ");
setTimeout(() =>
